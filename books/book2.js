...
Observer.fire('test', {msg: '传递参数111'});
//对象解耦
...
var MarryState = function() {
  ...
  return {change: Action.chageState, goes: Action.goes}
};
//测试
...
console.log(demo);
A.extend(A.fn, {version: 1});
A.extend(A, {name: 'john'});
//事件方法处理
A.fn.extend({
  on: (function() {
...
//测试
A('div').css({height: '30px', 'backgroud-color': 'red'}).attr('class', 'demo').html('add text').on('click', function() {
  console.log('clicked');
});
/*************************************
 * 第28章 : 委托模式
